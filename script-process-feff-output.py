#!/usr/bin/env python3
"""Thin entry-point shim -> xas_pipeline.stages.feff_process.
...
importlib-by-path consumers. Retired for a console_script in phase 9.
"""
...
from xas_pipeline.stages import feff_process as _stage
